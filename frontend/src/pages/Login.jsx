    ...
    <div className="dark min-h-screen flex items-center justify-center p-4 bg-[#080808] relative overflow-hidden">
      ...
      <GlassCard className="w-full max-w-md p-8 md:p-10 relative z-10 !bg-[#080808]/80 !border-[#2E4657]/50 shadow-2xl shadow-black/50">
        <div className="text-center mb-8">
          <div className="inline-flex items-center justify-center w-[120px] h-[120px] mb-4 rounded-full bg-white overflow-hidden ring-4 ring-white/10 shadow-[0_0_20px_rgba(255,255,255,0.15)]">
            <img src="/dpm_logo.png" alt="Logo" className="w-full h-full object-contain object-center scale-90" />
          </div>
